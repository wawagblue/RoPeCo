...
#endif
const int buzzer = 12; //buzzer to arduino pin 2
...
void updateScreen() {
  if (changeDisplay) {
    if (selectedMenu == START_MENU) {
      ...
      lcd.display();
      lcd.setCursor(0, 0);
      lcd.print("RoPeCo  " OOROBOT_VERSION);
      lcd.setCursor(0, 1);
      lcd.print(F("Insira comandos!"));
#ifdef HAVE_BLUETOOTH
      BTSerie.println("RoPeCo " OOROBOT_VERSION);
